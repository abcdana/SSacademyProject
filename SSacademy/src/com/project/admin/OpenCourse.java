...
public class OpenCourse {
	...
	public void openCourseList() {
		...
		for (OpenCourseListDTO dto : list) {
			...
			if(num.equals("0")) {
				...
				System.out.println();
				System.out.println("\t\t** 해당 과정은 없습니다. 다시 입력해주세요. **");
				pause();
				openCourseList();
			}
	...
	public void openCourseRoomEdit(String seqOpenCourse) {
		...
		if(result == 1) {
			System.out.println();
			System.out.println("\t* 강의실 수정이 완료되었습니다. 이전화면으로 이동합니다.");
			pause();
			openCourseEdit();
		} else {
			System.out.println();
			System.out.println("\t* 강의실을 수정할 수 없습니다. 이전화면으로 이동합니다.");
			pause();
			openCourseEdit();
		}
	...
	private void openCourseDateEdit(String seqOpenCourse) {
		...
		if(result == 1) {
			System.out.println();
			System.out.println("\t* 날짜 수정이 완료되었습니다.");
			pause();
			openCourseEdit();
			
		} else {
			System.out.println();
			System.out.println("\t* 날짜를 수정할 수 없습니다.");
			pause();
			openCourseEdit();
		}
	...
	private void openBasicCourseEdit(String seqOpenCourse) {
		...
		if(result == 1) {
			System.out.println();
			System.out.println("\t* 기초과정번호 수정이 완료되었습니다. 이전화면으로 이동합니다.");
			pause();
			openCourseEdit();
			
		} else {
			System.out.println();
			System.out.println("\t* 기초과정번호를 수정할 수 없습니다. 이전화면으로 이동합니다.");
			pause();
			openCourseEdit();
		}
